...
<div>
    <div class="content">
        <div class="tab-block information-tab">
            ...
            <div>
                <div style="text-align:center;">
                    <div class="search bar6">
                        <form action="internGetAttempts.action">
                            ...
                            <input type="text" style="height: 40px;width: 400px;display: inline-block;" name="topicNameSearched"placeholder="Search Topic..." value="<s:property value="topic"/>">
            ...
            <div style="text-align:center">
                <br>
                <a href="<s:url action="internGetHistoryAttempt"><s:param name="pageNumber" value="1"></s:param></s:url>">First Page</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                <s:if test="%{pageNumber != 1}">
                    <a href="<s:url action="internGetHistoryAttempt"><s:param name="pageNumber" value="pageNumber-1"></s:param></s:url>">Previous page</a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                </s:if>
                <s:bean name= "org.apache.struts2.util.Counter"  var= "counter">
                    <s:param name="first"  value= "1"  />
                    <s:param name="last"  value= "%{attemptNumber/5+1}"/>
                    <s:iterator status="status">
                        <a href="<s:url action="internGetHistoryAttempt"><s:param name="pageNumber" value="%{#status.index+1}"></s:param></s:url>"><s:property value="%{#status.index+1}"/></a>&nbsp;
                    </s:iterator>
                </s:bean>
                &nbsp;&nbsp;&nbsp;&nbsp;|
                <s:if test="%{pageNumber != attemptNumber/5+1}">
                    <a href="<s:url action="internGetHistoryAttempt"><s:param name="pageNumber" value="pageNumber+1"></s:param></s:url>">Next Page</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                </s:if>
                <a href="<s:url action="internGetHistoryAttempt"><s:param name="pageNumber" value="%{attemptNumber/5+1}"></s:param></s:url>">Last Page</a>
            </div>
