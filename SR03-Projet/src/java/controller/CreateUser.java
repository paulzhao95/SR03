...
public class CreateUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_type.equals("administrator")) {
            usersTable.put(usersTable.size(), new Administrator(request.getParameter("User email"), request.getParameter("User password"), request.getParameter("User name"), true, request.getParameter("User company"), request.getParameter("User telephone"), new Timestamp(now.getTime())));
        } else {
            usersTable.put(usersTable.size(), new Intern(request.getParameter("User email"), request.getParameter("User password"), request.getParameter("User name"), true, request.getParameter("User company"), request.getParameter("User telephone"),new Timestamp(now.getTime())));
        }
